...
void ggml_compute_forward_argmax_first(const struct ggml_compute_params * params, struct ggml_tensor * dst);
...
void ggml_compute_forward_flash_attn_rel_pos(const struct ggml_compute_params * params, struct ggml_tensor * dst);
...
void ggml_compute_forward_lstm_seq(const struct ggml_compute_params * params, struct ggml_tensor * dst);
