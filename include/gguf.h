...
extern "C" {
    ...
    GGML_API uint32_t       gguf_get_tensor_n_dims(const struct gguf_context * ctx, int64_t tensor_id);
    GGML_API int64_t        gguf_get_tensor_dim   (const struct gguf_context * ctx, int64_t tensor_id, int32_t dim);
